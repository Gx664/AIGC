...
**No pressure at all - give only if you want to. It is not moral coercion.** The author is still a middle-school student with a tiny allowance, but building this project is already meaningful on its own; your support is just extra encouragement.
...
The author is still a student (**14 years old when this project was released**); the code may have flaws. Please be kind - friendly suggestions and improvements are always welcome. This project is free and open source, for learning and exchange only.
