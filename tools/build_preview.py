...
T = {
    ...
    "nopressure": {"zh": "想给就给，不想给就不给，绝非道德绑架。作者还是一名初中生，零花钱不多，但做这个项目本身已经很有意义，你的支持只是额外的鼓励。", "en": "No pressure at all - give only if you want to. The author is a middle-school student; building this project is already meaningful on its own."},
    ...
    "disc_body": {"zh": "本人还是一名学生，项目发布时 14 岁，代码可能存在不足，不好勿喷，欢迎友善的建议与改进。本项目免费开源，仅供学习交流。", "en": "The author is still a student (14 when released); the code may have flaws. Please be kind. Free and open source, for learning and exchange only."},
...
<div class="wrap">
  ...
  <section>
    ...
    <p><b data-i18n="nopressure">想给就给，不想给就不给，绝非道德绑架。作者还是一名初中生，零花钱不多，但做这个项目本身已经很有意义，你的支持只是额外的鼓励。</b></p>
    ...
    <p data-i18n="disc_body">本人还是一名学生，项目发布时 14 岁，代码可能存在不足，不好勿喷，欢迎友善的建议与改进。本项目免费开源，仅供学习交流。</p>
