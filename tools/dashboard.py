...
<div class="wrap">
  ...
  <div id="aboutModal" onclick="if(event.target===this)closeAbout()">
    <div class="about-box">
      ...
      <p data-i18n="m_nopressure">想给就给，不想给就不给，绝非道德绑架。作者还是一名学生，零花钱不多，但做这个项目本身已经很有意义。</p>
      ...
      <p data-i18n="m_dev_body">部分代码由 DeepSeek V4 Flash + Codex 辅助开发；作者还是学生。</p>
...
const I18N = {
  ...
  m_nopressure:{zh:'想给就给，不想给就不给，绝非道德绑架。作者还是一名学生，零花钱不多，但做这个项目本身已经很有意义。',en:'No pressure at all - give only if you want to. The author is a student; building this project is already meaningful on its own.'},
  ...
  m_dev_body:{zh:'部分代码由 DeepSeek V4 Flash + Codex 辅助开发；作者还是学生。',en:'Partly written and debugged with DeepSeek V4 Flash + Codex; the author is a student.'},
